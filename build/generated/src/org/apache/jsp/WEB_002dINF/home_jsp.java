...
public final class home_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            background: #F5D487; /* Light golden background */\n");
      ...
      out.write("\n");
      out.write("        // Function to display each word one by one\n");
      out.write("        function displayParagraph(paragraph, callback) {\n");
      out.write("            container.innerHTML = \"\";  // Clear previous paragraph\n");
      ...
      out.write("                    container.innerHTML += words[wordIndex] + \" \";\n");
      out.write("                    wordIndex++;\n");
      out.write("                } else {\n");
      out.write("                    clearInterval(interval);\n");
      out.write("                    if (callback) callback();\n");
      out.write("                }\n");
      out.write("            }, 200);  // Word delay in ms\n");
      out.write("        }\n");
      out.write("\n");
      out.write("        // Recursive function to handle multiple paragraphs\n");
      ...
      out.write("                    setTimeout(startParagraphs, 1000);  // Wait before starting next paragraph\n");
      out.write("                });\n");
      out.write("            } else {\n");
      out.write("                // Show Explore button after all paragraphs are done\n");
      out.write("                exploreBtn.style.opacity = 1;\n");
      out.write("            }\n");
      out.write("        }\n");
      out.write("\n");
      out.write("        // Start the animation\n");
      out.write("        window.onload = startParagraphs;\n");
      out.write("    </script>\n");
      out.write("\n");
      out.write("</body>\n");
      out.write("</html>\n");
